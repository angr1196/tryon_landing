...
import stylesBg from './TokenomicsBG.module.css'
...
import tokenomics7 from '../../assets/decorations/tokenomics7.png'
...
const TokenomicsBlock = () => {
    ...
    return (
        <div id='tokenomics' className={styles.tokenomicsSection}>
