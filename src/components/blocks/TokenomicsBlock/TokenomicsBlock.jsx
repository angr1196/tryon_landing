    ...
    return (
        <section id='tokenomics' className={styles.tokenomicsSection}>
            <div className={styles.bg}>
                <img className={styles.decor1} src={tokenomics1} alt="decorarion" />
                <img className={styles.decor2} src={tokenomics2} alt="decorarion" />
                <img className={styles.decor3} src={tokenomics3} alt="decorarion" />
                <img className={styles.decor4} src={tokenomics3} alt="decorarion" />
                <img className={styles.decor5} src={tokenomics4} alt="decorarion" />
                <img className={styles.decor6} src={tokenomics5} alt="decorarion" />
                <img className={styles.decor7} src={tokenomics6} alt="decorarion" />
                <img className={styles.decor8} src={tokenomics2} alt="decorarion" />

                <img className={styles.decor9} src={tokenomics8} alt="decorarion" />
                <img className={styles.decor10} src={tokenomics9} alt="decorarion" />
                <img className={styles.decor11} src={tokenomics10} alt="decorarion" />
            </div>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.topBlock}>
                    ...
                    <div className={styles.topImageWrapper}>
                        <img className={styles.topBlockImage} src={image3} alt="decoration"/>
                    </div>
                </div>
                ...
                <div className={styles.bottomBlock}>
                    ...
                    <div className={styles.bottomImageWrapper}>
                        <img className={styles.bottomBlockImage} src={diagram} alt="diagram" />
                    </div>
                </div>
            </div>
        </section>
...
export default memo(TokenomicsBlock);